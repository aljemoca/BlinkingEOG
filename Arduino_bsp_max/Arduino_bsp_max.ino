...
int hsvg[21]={758,90,-390,-705,-874,-919,-860,-717,-513,-267,0,267,513,717,860,919,874,705,390,-90,-758};
int asvg = 1000;
...
void DSP_layer(void)
{
 ...
 // datafil=filter1.assess(static_cast<int>(input));
    datafil = filter2.assess(static_cast<int>(input));
...
void Classification_layer(void)
{
  ...
  if(!ColaDSP.isempty())
  {
      ...
      ColaPulsos.enqueue(res*abs(data));
